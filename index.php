	...
	<body>
		...
		<main>
			...
			<section id="contactenos" class="seccion">
				<iframe width="520" height="400" frameborder="0"  src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20cuenca+(ecuador)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
				<div class="container-fluid">
					<div class="row">
									...
									if($_SERVER["REQUEST_METHOD"] == "POST")
									{
										...
										if(isset($nombre))
										{
											if(isset($email))
											{
												if(isset($mensaje))
												{
													$para = "homero.vuelve@gmail.com"
													$asunto = "Esto es una prueba";
													$cuerpo = $nombre."\n".$email."\n".$mensaje;
													$adicional = "From:     paochalco14@gmailcom";
			...
			<div class="container">
				<div class="row">
					...
					<div class="columna columna-25 columna-mobile-100">
						...
						<ul>
							<li>paolachalco14@gmail.com</li>
							<li>0997216563</li>
							<li>ricaurte<br>cuenca - ecuador</li>
						</ul>
					</div>
					<div class="columna columna-25 columna-mobile-100">
						<h3>
